...
\section{Project Experience}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
           \resumeItem{Led design and development team to launch a cutting-edge platform to enhance student collaboration.}
           \resumeItem{Designed and implemented scalable APIs for managing user authentication and posts, hosted on AWS that served thousand of requests daily.}
           \resumeItem{Continuous Integration/Deployment pipeline integration, pull requests, code reviews, load/stress testing, unit/integration/e2e testing}
           \resumeItem{Efficiently managed an android application boasting over 5,000 users, consistently driving high user engagement with a monthly average of 1000 active users.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Designed \& engineered a high-functional and user-friendly sidebar component library with complete resizability using rollup, storybook and styled components.}
