    ...
    \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
            \resumeItemListStart
                ...
                \resumeItem{ React $|$ Redux $|$ Flutter $|$ Node $|$ Express $|$ Angular $|$ Flask $|$ Django $|$ Spring Boot $|$ OpenCV $|$ Git $|$ Scrum}
                \resumeItem{ Design Pattern $|$ Linux $|$ AWS $|$ Docker $|$ Microservices $|$ Distributed Systems $|$ Frontend $|$ Backend $|$ Full-Stack}
